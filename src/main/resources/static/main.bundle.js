...
module.exports = "<div>\n<div>\n  <ul class=\"list-group\">\n    <li class=\"list-group-item\" style=\"margin: 20px\">\n      Morbi leo risus\n    </li>\n  </ul>\n</div>\n<div>\n  <div *ngFor=\"let rec of recommendations\">\n    <!-- recommendations -->\n\n\n    <div>{{ rec.id }}</div>\n    <div>{{ rec.title }}</div>\n    <!-- <div>{{ rec.text }}</div>\n    <div>{{ rec.date }}</div> -->\n    <!--<td><a href=\"mailto:{{ user.email }}\">{{ user.email }}</a></td>-->\n\n\n  </div>\n</div>\n<div>\n  <ul class=\"list-group\" *ngFor=\"let rec2 of recommendations\">\n    <li class=\"list-group-item \">{{ rec2.id }}</li>\n    <li class=\"list-group-item\">{{ rec2.title }}</li>\n    <!-- <li class=\"list-group-item\">{{ rec2.text }}</li>\n    <li class=\"list-group-item\">{{ rec2.date }}</li>  -->\n  </ul>\n  <ul class=\"list-group\">\n    <li class=\"list-group-item\" style=\"margin: 20px\">\n      Morbi leo risus\n    </li>\n  </ul>\n</div>\n</div>\n"
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.ngOnInit = function () {
        // this.recService.findAll().subscribe(data => {
        ...
        //   this.search = data;
        // });
        // console.log(this.search.total_results);
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__recommendation_recommendation_component__ = __webpack_require__("./src/app/recommendation/recommendation.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__recommendation_recommendation_service__ = __webpack_require__("./src/app/recommendation/recommendation.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["E" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_5__recommendation_recommendation_component__["a" /* RecommendationComponent */],
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_7__recommendation_recommendation_service__["a" /* RecommendationService */]],
...
var RecommendationComponent = /** @class */ (function () {
    ...
    RecommendationComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            ...
            styles: [__webpack_require__("./src/app/recommendation/recommendation.component.css")]
        }),
        __metadata("design:paramtypes", [])
...
/***/ "./src/app/recommendation/recommendation.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var RecommendationService = /** @class */ (function () {
    function RecommendationService(http) {
        this.http = http;
        this.recommendationsUrl = 'http://localhost:8080/rec';
    }
    RecommendationService.prototype.findAll = function () {
        return this.http.get(this.recommendationsUrl);
    };
    RecommendationService.prototype.save = function (recommendation) {
